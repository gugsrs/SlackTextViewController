...
- (void)slk_setupViewConstraints
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(0)-[leftButton(0)]-(-5)-[textView]-(right)-[rightButton(0)]-(right)-|" options:0 metrics:metrics views:views]];
